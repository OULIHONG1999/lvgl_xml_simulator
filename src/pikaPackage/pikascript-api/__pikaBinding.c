...
void Math_Adder_byIntMethod(PikaObj *self, Args *_args_){
...
#ifndef PIKA_MODULE_MATH_DISABLE
void Math_Multiplier_byFloatMethod(PikaObj *self, Args *_args_){
    pika_float a = args_getFloat(_args_, "a");
    pika_float b = args_getFloat(_args_, "b");
...
void Math_Multiplier_byIntMethod(PikaObj *self, Args *_args_){
    int a = args_getInt(_args_, "a");
    int b = args_getInt(_args_, "b");
